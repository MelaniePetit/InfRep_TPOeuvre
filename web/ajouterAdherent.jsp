                ...
                <div class="jumbotron">
                    <form  class="form-horizontal" name='identification' method="post" action="Controleur?action=insererAdherent" onsubmit="return teste()">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="txtnom" value=""  id ="nom" placeholder="Nom de l'adhérent">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" >Prénom</label>
                            <div class="col-sm-5">
                                <input type="text" name="txtprenom"  id ="prenom" class="form-control" placeholder="Prénom de l'adhérent">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" >Ville</label>
                            <div class="col-sm-5">
                                <input type="text" name="txtville" id ="ville" class="form-control" placeholder="Ville de l'adhérent">
                            </div>
                        </div>
                        <!-- Boutons Ajouter -->
                        <div class="form-group">
